...
<template>
  ...
  <div class="d-flex align-center flex-wrap gap-2 mt-4">
    <v-btn color="primary">
      Start
      <v-tooltip activator="parent" anchor="start">Tooltip</v-tooltip>
    </v-btn>

    <v-btn color="secondary">
      End
      <v-tooltip activator="parent" anchor="end">Tooltip</v-tooltip>
    </v-btn>

    <v-btn color="warning">
      Top
      <v-tooltip activator="parent" anchor="top">Tooltip</v-tooltip>
    </v-btn>
