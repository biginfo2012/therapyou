...
import ButtonsPlain from "@/components/vuetifyComponents/buttons/ButtonsPlain.vue";
import ButtonsContained from "@/components/vuetifyComponents/buttons/ButtonsContained.vue";
...
<template>
  ...
  <v-row>
    ...
    <v-col cols="12" sm="12" lg="6">
      <BaseCard heading="Contained Text">
        <ButtonsContained />
      </BaseCard>
    </v-col>
